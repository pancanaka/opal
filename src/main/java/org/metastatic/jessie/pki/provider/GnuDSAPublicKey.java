...
public class GnuDSAPublicKey implements DSAPublicKey {
	...
	public GnuDSAPublicKey(BigInteger y, BigInteger p, BigInteger q,
			BigInteger g) {
		this.y = y;
		this.p = p;
		this.q = q;
	...
	/**
	 * The encoded form of DSA public keys is: <blockquote>
	 * 
	 * <pre>
	...
	public byte[] getEncoded() {
		...
		try {
			...
			alg.add(new DERValue(DER.OBJECT_IDENTIFIER, new OID(
			...
			spki.add(new DERValue(DER.BIT_STRING,
					new BitString(y.toByteArray())));
	...
	public String toString() {
		return "GnuDSAPublicKey: y=" + (y != null ? y.toString(16) : "(null)")
