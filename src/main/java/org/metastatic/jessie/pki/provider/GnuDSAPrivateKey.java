...
class GnuDSAPrivateKey implements DSAPrivateKey {
	...
	public GnuDSAPrivateKey(BigInteger x, BigInteger p, BigInteger q,
			BigInteger g) {
		this.x = x;
		this.p = p;
		this.q = q;
	...
	/**
	 * Encodes this key as a <code>PrivateKeyInfo</code>, as described in PKCS
	 * #8. The ASN.1 specification for this structure is: <blockquote>
	 * 
	 * <pre>
	...
	public byte[] getEncoded() {
		...
		try {
			...
			algId.add(new DERValue(DER.OBJECT_IDENTIFIER, new OID(
					"1.2.840.10040.4.1")));
			...
			DERWriter.write(out, new DERValue(DER.CONSTRUCTED | DER.SEQUENCE,
					pki));
	...
	public String toString() {
		return "GnuDSAPrivateKey: x=" + (x != null ? x.toString(16) : "null")
				+ " p=" + (p != null ? p.toString(16) : "null") + " q="
