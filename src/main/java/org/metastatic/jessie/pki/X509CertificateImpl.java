...
import org.metastatic.jessie.pki.ext.BasicConstraints;
import org.metastatic.jessie.pki.ext.ExtendedKeyUsage;
import org.metastatic.jessie.pki.ext.Extension;
import org.metastatic.jessie.pki.ext.IssuerAlternativeNames;
import org.metastatic.jessie.pki.ext.KeyUsage;
import org.metastatic.jessie.pki.ext.SubjectAlternativeNames;
 ...
 */
public class X509CertificateImpl extends X509Certificate implements
		Serializable, GnuPKIExtension {
		...
		try {
			if (other instanceof X509CertificateImpl)
				return Arrays.equals(encoded,
						((X509CertificateImpl) other).encoded);
	...
	private void parse(InputStream encoded) throws Exception {
		...
		subjectKey = spkFac.generatePublic(new X509EncodedKeySpec(spki
				.getEncoded()));
