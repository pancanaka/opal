...
/**
 * A filter input stream that records every byte read from the underlying input
 * stream. This class is useful for protocols that require portions of the
 * communication to be saved, such as the handshake and key derivation in SSL.
 * 
