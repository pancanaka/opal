	...
	public Jessie() {
		...
		AccessController.doPrivileged(new PrivilegedAction() {
			public Object run() {
				...
				put("KeyManagerFactory.JessieX509",
						X509KeyManagerFactory.class.getName());
				put("TrustManagerFactory.JessieX509",
						X509TrustManagerFactory.class.getName());
				put("TrustManagerFactory.SRP",
						SRPTrustManagerFactory.class.getName());

				put("SecureRandom.CSPRNG", CSPRNGSpi.class.getName());

				put("AlgorithmParameters.DSA",
						org.metastatic.jessie.pki.provider.DSAParameters.class
								.getName());
				...
				put("CertificateFactory.X509",
						org.metastatic.jessie.pki.provider.X509CertificateFactory.class
								.getName());
				...
				put("KeyFactory.Encoded",
						org.metastatic.jessie.pki.provider.EncodedKeyFactory.class
								.getName());
				...
				put("KeyFactory.X509",
						org.metastatic.jessie.pki.provider.EncodedKeyFactory.class
								.getName());
				put("KeyFactory.PKCS#8",
						org.metastatic.jessie.pki.provider.EncodedKeyFactory.class
								.getName());
				put("KeyFactory.PKCS8",
						org.metastatic.jessie.pki.provider.EncodedKeyFactory.class
								.getName());

				put("KeyFactory.RSA",
						org.metastatic.jessie.pki.provider.RSAKeyFactory.class
								.getName());

				put("MessageDigest.MD2",
						org.metastatic.jessie.pki.provider.MD2.class.getName());
				...
				put("MessageDigest.MD5",
						org.metastatic.jessie.pki.provider.MD5.class.getName());
				...
				put("MessageDigest.SHA1",
						org.metastatic.jessie.pki.provider.SHA1.class.getName());
				...
				put("Signature.DSA",
						org.metastatic.jessie.pki.provider.DSASignature.class
								.getName());
				...
				put("Signature.MD2withRSA",
						org.metastatic.jessie.pki.provider.MD2withRSA.class
								.getName());
				...
				put("Signature.MD5withRSA",
						org.metastatic.jessie.pki.provider.MD5withRSA.class
								.getName());
				...
				put("Signature.SHA1withRSA",
						org.metastatic.jessie.pki.provider.SHA1withRSA.class
								.getName());
