...
public final class Util {
	 ...
	 * @param prefix
	 *            A string to prepend to every line.
	 ...
	 * @param len
	 *            The number of bytes to return. This value can be larger than
	 *            <i>buffer.length - off</i>, in which case the rest of the
	 *            returned byte array will be filled with zeros.
	 * @throws IndexOutOfBoundsException
	 *             If <i>off</i> or <i>len</i> is negative, or if <i>off</i> is
	 ...
	 * 
	 * @param array
	 *            The array to transform. It does not need to be of uniform
	 *            type.
	 * @param returnType
	 *            The desired return type of the returned array. This must by
	 *            the <i>component</i> type, not the array type.
	 * @param method
	 *            The name of the method to invoke from each object.
	 * @param args
	 *            The arguments to pass to the method, or <tt>null</tt> if the
	 *            method takes no arguments.
	 * @throws InvocationTargetException
	 *             If an exception occurs while calling <i>method</i> of any
	 *             object.
	 * @throws NoSuchMethodException
	 *             If <i>method</i> is not the name of a valid method of any
	 *             component of the array.
	 * @throws ClassCastException
	 *             If the returned object from the method is not assignable to
	 *             the return type.
	 * @throws IllegalArgumentException
	 *             If <i>args</i> is not appropriate for <i>method</i>
	 * @throws IllegalAccessException
	 *             If <i>method</i> is not accessible.
	 ...
	 *         set.
	 * @throws SecurityException
	 *             If the Jessie code still does not have permission to read the
	 *             property.
	 */
