...
class GNUSecurityParameters implements SecurityParameters {
	 ...
	 * 
	 * @param fragment
	 *            The fragment to decrypt.
	 * @param version
	 *            The protocol version of the fragment's record.
	 * @param type
	 ...
	 *             If the inflated data is too large.
	 * @throws SSLException
	 *             If decompressing fails.
	 */
	 ...
	 *            The fragment bytes.
	 * @param off
	 *            The offset from whence to read.
	 * @param len
	 *            The size of the fragment.
	 * @param type
	 *            The content-type for this record.
	 * @param out
	 *            The output stream to write the record to.
	 * @throws IOException
	 *             If an I/O error occurs.
	 * @throws SSLException
	 *             If compression fails.
	 * @throws OverflowException
	 *             If compression inflates the data beyond the fragment length
	 *             plus 1024 bytes.
	 */
	public synchronized byte[] encrypt(byte[] buf, int off, int len,
		...
		// If we are compressing, do it.
                //System.out.println("La message a cryptée est : " + Conversion.arrayToHex(buf));
		if (deflater != null) {
	 ...
	 *            The output buffer.
	 * @param outOffset
	 *            The offest into the output buffer.
	 * @param random
	 *            The ARCFOUR PRNG.
	 */
