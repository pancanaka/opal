...
public interface SecurityParameters {
	 ...
	 * 
	 * @param fragment
	 *            The fragment being decrypted.
	 * @param version
	 *            The version field of the received text.
	 * @param type
	 *            The type field of the received text.
	 * @return The decrypted fragment.
	 * @throws MacException
	 *             If the MAC could not be verified, or if the padding on the
	 *             decrypted fragment is incorrect.
	 * @throws OverflowException
	 *             If the processed text overflows the configured maximum
	 *             fragment size.
	 * @throws SSLException
	 ...
	 * @throws OverflowException
	 *             If deflating increases the size of the fragment too much.
	 * @throws SSLException
	 *             If any other error occurs.
	 */
	...
	/**
	 * Set all crypto primitives to <code>null</code>, meaning that any calls to
	 * {@link #encrypt(byte[],int,int,org.metastatic.jessie.provider.ContentType)}
	 * or {@link
	 * #decrypt(byte[],org.metastatic.jessie.provider.ProtocolVersion,org.
	 * metastatic.jessie.provider.ContentType}) will perform the identity
	 * transformation.
	 */
	void reset();
	 ...
	 * 
	 * @param deflate
	 *            Whether or not to deflate outgoing fragments.
	 */
	 ...
	 * 
	 * @param inflate
	 *            Whether or not to inflate incoming fragments.
	 */
	 ...
	 *             If the argument is not appropriate for the implementation.
	 */
