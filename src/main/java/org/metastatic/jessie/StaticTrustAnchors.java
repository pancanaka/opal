...
/**
 * This class implements a simple set of trust anchors suitable for initializing
 * a TrustManagerFactory for the "JessieX509" algorithm.
 * <p>
 * The important field of this class is the {@link #CA_CERTS} constant, which
 * contains an array of commonly accepted CA certificates.
 */
public class StaticTrustAnchors implements ManagerFactoryParameters {
	 ...
	 * certificates is the same as the default CA certificates used by Mozilla.
	 */
	...
	static {
		...
		CA_CERTS = new StaticTrustAnchors(
				(X509Certificate[]) certs.toArray(new X509Certificate[0]));
	}
}
