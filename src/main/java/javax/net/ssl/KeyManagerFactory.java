...
public class KeyManagerFactory {
	 ...
	 *            The name of this algorithm.
	 */
	protected KeyManagerFactory(KeyManagerFactorySpi kmfSpi, Provider provider,
			String algorithm) {
		this.kmfSpi = kmfSpi;
	...
	/**
	 * Get an instance of the named key manager factory, from the first provider
	 * that implements it.
	 * 
	 * @param algorithm
	...
	public static final KeyManagerFactory getInstance(String algorithm,
		...
		try {
			return new KeyManagerFactory(
					(KeyManagerFactorySpi) Engine.getInstance(
							KEY_MANAGER_FACTORY, algorithm, provider),
					provider, algorithm);
