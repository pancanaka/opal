...
//      return data;
        ...
        if (DEBUG && debuglevel > 6)
            debug(TRACE, "Incoming buffer (before security): " + Util.dumpString(incoming, offset, len));
...
//      return result;
        ...
        if (DEBUG && debuglevel > 6)
            debug(TRACE, "Outgoing buffer (before security) (hex): " + Util.dumpString(outgoing, offset, len));
        if (DEBUG && debuglevel > 6)
            debug(TRACE, "Outgoing buffer (before security) (str): \"" + new String(outgoing, offset, len) + "\"");
        ...
        try {
            ...
            if (outCipher != null) {
                ...
                if (DEBUG && debuglevel > 6)
                    debug(TRACE, "Encoding c (encrypted plaintext): " + Util.dumpString(result));
                ...
                if (DEBUG && debuglevel > 6)
                    debug(TRACE, "Encoding p (plaintext): " + Util.dumpString(outgoing, offset, len));
