 ...
 * </p>
 * <p/>
 * <strong>NOTE:</strong> This package is deprecated. Use
...
public abstract class Certificate {
     ...
     * @throws NoSuchAlgorithmException If the algorithm used to sign the certificate is not
     *                                  available.
     * @throws InvalidKeyException      If the supplied key is not appropriate for the certificate's
     *                                  signature algorithm.
     ...
     * @throws InvalidKeyException      If the supplied key is not appropriate for the certificate's
     *                                  signature algorithm.
     * @throws NoSuchProviderException  If <i>sigProvider</i> is not the name of an installed
     *                                  provider.
     * @throws SignatureException       If the signature could not be verified.
     */
