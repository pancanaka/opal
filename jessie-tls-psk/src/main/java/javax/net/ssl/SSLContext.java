...
public class SSLContext {
     ...
     * @throws NoSuchAlgorithm If no provider implements the given protocol.
     */
    ...
    public static final SSLContext getInstance(String protocol,
        ...
        try {
            return new SSLContext((SSLContextSpi) Engine.getInstance(
                    SSL_CONTEXT, protocol, provider), provider, protocol);
