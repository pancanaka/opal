...
public abstract class HttpsURLConnection extends HttpURLConnection {
     ...
     * @throws SecurityException        If there is a security manager currently installed and the
     ...
     * @throws IllegalArgumentException If <i>newDefault</i> is null.
     * @throws SecurityException        If there is a security manager installed and a call to
     ...
     * @throws IllegalArgumentException If <i>hostnameVerifier</i> is null.
     */
     ...
     * @throws IllegalStateException      If the connection has not yet been established.
     * @throws SSLPeerUnverifiedException If the peer could not be verified.
     */
