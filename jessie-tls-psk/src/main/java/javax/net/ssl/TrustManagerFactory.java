...
public class TrustManagerFactory {
     ...
     * @throws NoSuchAlgorithmException If no provider implements the given algorithm.
     */
     ...
     * @return The instance of the trust manager factory.
     * @throws NoSuchAlgorithmException If the provider does not implement the given algorithm.
    ...
    public static final TrustManagerFactory getInstance(String algorithm,
        ...
        try {
            return new TrustManagerFactory(
                    (TrustManagerFactorySpi) Engine.getInstance(
                            TRUST_MANAGER_FACTORY, algorithm, provider),
                    provider, algorithm);
