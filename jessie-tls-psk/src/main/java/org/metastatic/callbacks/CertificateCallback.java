...
/**
 * <p>
 * A callback for determining whether or not a certificate chain, the trust of
 * which could not be established, should be accepted by an application.
 * </p>
 * <p>
 * The questionable certificate chain is included in this callback, and handlers
 * that accept this callback should provide some mechanism for displaying these
 * certificates when asking for confirmation. When the user allows the
 * certificates, the callback handler should set the selected index to
 * {@link #ACCEPT}. Otherwise, {@link #REJECT}.
 * </p>
 */
public class CertificateCallback implements Callback {
    ...
    /**
     * <p>
     * Create a new callback with the given prompt and certificates. The default
     * index will be set to {@link #REJECT}.
     * </p>
     *
     ...
     * @throws IllegalArgumentException If the prompt or certificates parameter is null or empty, or
     *                                  if the default index is not {@link #ACCEPT} nor
     *                                  {@link #REJECT}.
     */
    public CertificateCallback(String prompt, Certificate[] certs,
                               int defaultIndex) {
     ...
     * @throws IllegalArgumentException If the selected index is neither {@link #ACCEPT} nor
     *                                  {@link #REJECT}.
     */
