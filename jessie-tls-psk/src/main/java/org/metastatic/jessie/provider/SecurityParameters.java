...
public interface SecurityParameters {
     ...
     * @throws MacException      If the MAC could not be verified, or if the padding on the
     *                           decrypted fragment is incorrect.
     * @throws OverflowException If the processed text overflows the configured maximum
     *                           fragment size.
     ...
     * @throws OverflowException If deflating increases the size of the fragment too much.
     * @throws SSLException      If any other error occurs.
     */
     ...
     * @throws ClassCastException If the argument is not appropriate for the implementation.
     */
