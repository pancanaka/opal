...
public final class Util {
     ...
     */
    static String toAsciiString(byte[] buf) throws UnsupportedEncodingException {
        String ascii = null;
        if (buf != null) {
     ...
     * @param len   The target length of the string. The string is zero-padded to
     ...
     * @param len    The number of bytes to return. This value can be larger than
     *               <i>buffer.length - off</i>, in which case the rest of the
     *               returned byte array will be filled with zeros.
     * @return The trimmed byte array.
     * @throws IndexOutOfBoundsException If <i>off</i> or <i>len</i> is negative, or if <i>off</i> is
     *                                   larger than the byte array's length.
     */
    ...
    /**
     * Returns the byte array representation of the given big integer with the
     * leading zero byte (if any) trimmed off.
     *
     * @param bi The integer to trim.
     * @return The byte representation of the big integer, with any leading zero
     *         removed.
     */
    ...
    /**
     * Transform an Object array into another by calling the given method on
     * each object. The returned object array will have the runtime type of
     * <i>returnType</i>. For example, the following will transform array of
     * objects into their String representations, returning a String array. For
     * example: <blockquote>
     * <p>
     * <code>
     ...
     * </blockquote>
     * <p/>
     * If any element of the given array is <tt>null</tt>, then that entry in
     * the returned array will also be <tt>null</tt>.
     *
     * @param array      The array to transform. It does not need to be of uniform
     *                   type.
     * @param returnType The desired return type of the returned array. This must by
     *                   the <i>component</i> type, not the array type.
     * @param method     The name of the method to invoke from each object.
     * @param args       The arguments to pass to the method, or <tt>null</tt> if the
     *                   method takes no arguments.
     * @return An array containing the output of <i>method</i> called on each
     *         element of <i>array</i> with <i>args</i>. The return type of the
     *         array will be an array of <i>returnType</i>.
     * @throws InvocationTargetException If an exception occurs while calling <i>method</i> of any
     *                                   object.
     * @throws NoSuchMethodException     If <i>method</i> is not the name of a valid method of any
     *                                   component of the array.
     * @throws ClassCastException        If the returned object from the method is not assignable to
     *                                   the return type.
     * @throws IllegalArgumentException  If <i>args</i> is not appropriate for <i>method</i>
     * @throws IllegalAccessException    If <i>method</i> is not accessible.
     * @throws SecurityException         If <i>method</i> is not accessible.
     */
    static Object[] transform(Object[] array, Class returnType, String method,
                              Object[] args) throws InvocationTargetException,
            NoSuchMethodException, IllegalAccessException {
        if (args == null)
            args = new Object[0];
        Object[] result = (Object[]) Array
                .newInstance(returnType, array.length);
     ...
     * @return The property named <i>name</i>, or null if the property is not
     *         set.
     * @throws SecurityException If the Jessie code still does not have permission to read the
     *                           property.
     */
