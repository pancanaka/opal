...
/**
 * The RSA signature algorithm as used in the SSL protocol. Note that this is
 * different from the RSA signature used to verify certificates.
 * <p>
 ...
 * </blockquote>
 * <p>
 * Where a <code>digitally-signed struct</code> is RSA-encrypted with block type
 * 0 or 1 according to PKCS #1, version 1.5.
 * </p>
 */
