    ...
    public String toString() {
        ...
        if (publicKey instanceof DHPublicKey) {
            ...
            out.println("    g = "
                    ...
                    + ";");
            out.println("    y = "
                    + ((DHPublicKey) publicKey).getY().toString(16) + ";");
            ...
            out.println("    exponent = "
                    + ((RSAPublicKey) publicKey).getPublicExponent().toString(
                    16) + ";");
            out.println("  } RSAPublicKey;");
        } else if (publicKey instanceof SRPPublicKey) {
            out.println("    N = "
                    + ((SRPPublicKey) publicKey).getN().toString(16) + ";");
            out.println("    g = "
                    + ((SRPPublicKey) publicKey).getG().toString(16) + ";");
            out.println("    salt = " + Util.toHexString(srpSalt, ':') + ";");
            out.println("    B = "
                    + ((SRPPublicKey) publicKey).getY().toString(16) + ";");
