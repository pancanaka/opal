...
/**
 * This class implements a {@link javax.net.ssl.TrustManagerFactory} engine for
 * the ``JessieX509'' algorithm.
 */
public class X509TrustManagerFactory extends TrustManagerFactorySpi {
    ...
    protected void engineInit(ManagerFactoryParameters params)
        ...
        if (params instanceof StaticTrustAnchors) {
            current = new Manager(
                    ((StaticTrustAnchors) params).getCertificates());
    ...
    private class Manager implements X509TrustManager {
        ...
        private void checkTrusted(X509Certificate[] chain, String authType)
            ...
            // Step 2: verify that the root of the chain was issued by a trust
            // anchor.
