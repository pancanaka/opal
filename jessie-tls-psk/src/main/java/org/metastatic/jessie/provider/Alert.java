...
/**
 * An alert message in the SSL protocol. Alerts are sent both as warnings which
 * may allow execution to continue, or they may be fatal, which will halt this
 * session. An alert object is composed of two enums -- the level, which
 * indicates the seriousness of the alert, and the description, which indicates
...
final class Alert implements Constructed {
    ...
    static Alert forName(String name) {
        ...
        } else if (name.equals("unknown_psk_identity")) {
            desc = Description.UNKNOWN_PSK_IDENTITY;
    ...
    public String toString() {
        ...
        return "struct {" + nl + "  level = " + level + ";" + nl
                + "  description = " + description + ";" + nl + "} Alert;" + nl;
    }
    ...
    static final class Description implements Enumerated {
        ...
        static final Description CLOSE_NOTIFY = new Description(0),
                ...
                UNKNOWN_PSK_IDENTITY = new Description(115),
