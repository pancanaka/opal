 ...
 * <li>T. Kivinen and M. Kojo, "More Modular Exponential (MODP) Diffie-Hellman
 * groups for Internet Key Exchange
 * (IKE)", <a href="http://www.ietf.org/rfc/rfc3526.txt">RFC 3526</a>.</li>
 * </li>
 * <p>
...
final class DiffieHellman {
    ...
    /**
     * Get the system's Diffie-Hellman parameters, in which <i>g</i> is 2 and
     * <i>p</i> is determined by the property
     * <code>"jessie.keypool.dh.group"</code>. The default value for <i>p</i> is
     * 18, corresponding to {@link #GROUP_18}.
     */
