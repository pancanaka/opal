 ...
 * <p/>
 * <pre>
 * hash(MAC_write_secret, pad_2 + hash(MAC_write_secret + pad_1 + data));
 * </pre>
 * <p/>
 * <tt>hash</tt> is e.g. MD5 or SHA-1, <tt>pad_1</tt> is the value 0x36 48 times
 * for MD5 and 40 times for SHA-1, and <tt>pad_2</tt> is the value 0x5c repeated
 * similarly.
 */
