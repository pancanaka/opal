...
/**
 * The operation of this HMac is identical to normal HMacs, but this one allows
 * keys with short lengths (including zero).
 */
class TLSHMac extends HMac {
    ...
    public void init(Map attributes) throws InvalidKeyException,
        ...
        if (K == null) { // take it as an indication to re-use previous key if
            // set
            if (ipadHash == null) {
