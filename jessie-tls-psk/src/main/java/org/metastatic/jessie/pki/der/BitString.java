...
public class BitString implements Cloneable, Comparable, java.io.Serializable {
     ...
     * @param doShift     Pass true in this parameter if the byte array has not yet been
     *                    shifted left by <i>ignoredBits</i>.
     * @throws IllegalArgumentException If <i>ignoredBits</i> is negative or greater than 7.
