 ...
 * <p/>
 * OIDs are represented as a series of hierarcical tokens, each of which is
...
public class OID implements Cloneable, Comparable, java.io.Serializable {
     ...
     * @throws IllegalArgumentException If the string does not contain at least one integer.
     * @throws NumberFormatException    If the string does not contain only numbers and periods
     *                                  ('.').
     */
