...
public class X509CRLImpl extends X509CRL implements GnuPKIExtension {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof X509CRL))
            return false;
        return ((X509CRL) o).getRevokedCertificates().equals(
                revokedCerts.values());
    }
    ...
    public void verify(PublicKey key, String provider) throws CRLException,
            NoSuchAlgorithmException, InvalidKeyException,
            NoSuchProviderException, SignatureException {
    ...
    public boolean isRevoked(Certificate cert) {
        ...
        BigInteger certSerial = ((java.security.cert.X509Certificate) cert)
                .getSerialNumber();
    ...
    private void doVerify(Signature sig, PublicKey key) throws CRLException,
    ...
    private void parse(InputStream in) throws Exception {
        ...
        if (val.getLength() > sigAlgVal.getEncodedLength()) {
            val = der.read();
            debug("sig params tag = " + val.getTag() + " len == "
