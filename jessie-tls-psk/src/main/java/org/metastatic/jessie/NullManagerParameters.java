 ...
 * {@link javax.net.ssl.KeyManagerFactory} and
 * {@link javax.net.ssl.TrustManagerFactory} instances for the ``JessieX509''
 * algorithm, for cases when no keys or trusted certificates are desired or
 * needed.
 * <p/>
 * This is the default manager parameters object used in
 * {@link javax.net.ssl.KeyManagerFactory} instances if no key stores are
