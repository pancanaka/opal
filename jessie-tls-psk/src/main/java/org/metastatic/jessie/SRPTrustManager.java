 ...
 * This is a read-only interface to the {@link gnu.crypto.sasl.srp.PasswordFile}
 * class, with convenience methods to generate session key pairs.
 */
public interface SRPTrustManager extends TrustManager {
     ...
     * @return The session key pair, or <code>null</code> if there is no entry
     *         for <i>user</i>.
     */
